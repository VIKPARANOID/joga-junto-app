...
export default function LeaderboardScreen() {
  ...
  const [selectedFilter, setSelectedFilter] = useState<"all" | PositionClass>(
    "all"
  );
        ...
        <View className="p-6 gap-6">
          ...
          <View className="gap-3">
            ...
            <View className="flex-row gap-2 flex-wrap">
              ...
              {Object.values(RPG_CLASSES).map((rpgClass) => (
                <FilterButton
                  key={rpgClass.id}
                  label={rpgClass.emoji}
                  active={selectedFilter === rpgClass.id}
                  onPress={() => setSelectedFilter(rpgClass.id as PositionClass)}
                />
              ))}
            </View>
          </View>
          ...
          >
            ...
            <View className="gap-2">
              ...
              <StatRow label="Próximo Nível" value="1.000 XP" />
            </View>
          </View>
